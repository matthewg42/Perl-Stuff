...
=head1 SYNOPSIS
    ...
    my $r1 = Stuff::ExpirySet->new(100,200);
    print "upper = " . $r1->upper() . "\n"; 


=head1 DESCRIPTION

Stuff::ExpirySet is an object module that models simple numeric ranges.
...
with other Stuff::ExpirySets, testing if a range is bound by another range
and so on.
...
A new Stuff::ExpirySet is returned.  The lower and upper values of I<v1>
...
sub new {
    ...
    db_out(8,"Stuff::ExpirySet->new($values[0], $values[1]) OK", "M"); 
